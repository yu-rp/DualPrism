...
from aug import spectral_noise, spectral_mask
...
if __name__ == '__main__':
    ...
    parser.add_argument('--spectral_aug', type=str, default="mask")
    parser.add_argument('--std_dev', type=float, default=1.0)
    parser.add_argument('--freq', type=str, default='low', help='low,high,None')
    parser.add_argument('--freq_ratio', type=float, default=0.5, help="how much to be auged")
    parser.add_argument('--aug_prob', type=float, default=1.0,help="aug with probability aug_prob")
    parser.add_argument('--n_exp', type=int, default=0)
    parser.add_argument('--use_eigen_lock', action='store_false', default=True,help="whether use eigen lock to protect cpu running")
    ...
    folder_name = '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(args.seed, args.spectral_aug, args.std_dev,
                                            ...
                                            args.batch_size, args.lr,args.gmixup)
